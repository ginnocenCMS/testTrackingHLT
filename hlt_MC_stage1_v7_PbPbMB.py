# /users/ginnocen/HLTCleanedHFPbPbmenu755/V7 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/ginnocen/HLTCleanedHFPbPbmenu755/V7')
)
...
process.l1GtTriggerMenuXml = cms.ESProducer("L1GtTriggerMenuXmlProducer",
  ...
  DefXmlFile = cms.string('L1Menu_CollisionsHeavyIons2015_v2_L1T_Scales_20141121.xml'),
