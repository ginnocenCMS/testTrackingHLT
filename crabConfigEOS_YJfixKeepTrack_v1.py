...
config.General.requestName   = 'HeavyFlavourHLT_MVA_45_YJfixKeepTrack_v1'
config.General.transferLogs = True
config.section_("JobType")
config.JobType.pluginName  = 'Analysis'
config.JobType.inputFiles = ['rssLimit']
config.JobType.psetName    = 'hlt_MC_stage1_HFmenu_YJfixKeepTrack.py'
config.General.requestName = 'HeavyFlavourHLT_MVA_45_YJfixKeepTrack_v1'
...
config.Data.outLFNDirBase= '/store/group/phys_heavyions/ginnocen/HeavyFlavourHLT_MVA_45_YJfixKeepTrack_v1'
