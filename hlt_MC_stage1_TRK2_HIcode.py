# /users/ginnocen/HLTHeavyFlavourTracking/V49 (CMSSW_7_4_10_patch1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/ginnocen/HLTHeavyFlavourTracking/V49')
)
...
process.hltPrePuAK4CaloJet40Eta2p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltSinglePuAK4CaloJet40Eta2p5 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
...
process.hltPrePuAK4CaloJet60Eta2p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltSinglePuAK4CaloJet60Eta2p5 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 60.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 2.5 ),
...
process.hltPrePuAK4CaloJet80Eta2p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltSinglePuAK4CaloJet80Eta2p5 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 80.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 2.5 ),
...
process.hltPrePuAK4CaloJet100Eta2p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltSinglePuAK4CaloJet100Eta2p5 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
...
process.HLT_PuAK4CaloJet40_Eta2p5_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleJet8BptxAND + process.hltPrePuAK4CaloJet40Eta2p5 + process.HLTPuAK4CaloJetsSequence + process.hltSinglePuAK4CaloJet40Eta2p5 + process.HLTEndSequence )
process.HLT_PuAK4CaloJet60_Eta2p5_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleJet16BptxAND + process.hltPrePuAK4CaloJet60Eta2p5 + process.HLTPuAK4CaloJetsSequence + process.hltSinglePuAK4CaloJet60Eta2p5 + process.HLTEndSequence )
process.HLT_PuAK4CaloJet80_Eta2p5_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleJet28BptxAND + process.hltPrePuAK4CaloJet80Eta2p5 + process.HLTPuAK4CaloJetsSequence + process.hltSinglePuAK4CaloJet80Eta2p5 + process.HLTEndSequence )
process.HLT_PuAK4CaloJet100_Eta2p5_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleJet44BptxAND + process.hltPrePuAK4CaloJet100Eta2p5 + process.HLTPuAK4CaloJetsSequence + process.hltSinglePuAK4CaloJet100Eta2p5 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_DmesonTrackingGlobalPt8_Dpt20_v1, process.HLT_DmesonTrackingGlobalPt8_Dpt60_v1, process.HLT_DmesonTrackingGlobalPt8_Dpt40_v1, process.HLT_PuAK4CaloJet80Eta2p3_ForDmesons_v1, process.HLT_PuAK4CaloJet60Eta2p3_ForDmesons_v1, process.HLT_PuAK4CaloJet80Eta2p3_Forbjets_v1, process.HLT_PuAK4CaloJet60Eta2p3_Forbjets_v1, process.HLT_PuAK4CaloJet40_Eta2p5_v1, process.HLT_PuAK4CaloJet60_Eta2p5_v1, process.HLT_PuAK4CaloJet80_Eta2p5_v1, process.HLT_PuAK4CaloJet100_Eta2p5_v1, process.HLT_HIFullTrack12_v1, process.HLT_HIFullTrack45_L1Centrality010_v1, process.HLT_HIFullTrack45_L1Centrality1030_v1, process.HLT_HIFullTrack45_L1Centrality3050_v1, process.HLT_HIFullTrack45_L1Centrality50100_v1, process.HLT_HIFullTrack30_L1Centrality010_v1, process.HLT_HIFullTrack30_L1Centrality1030_v1, process.HLT_HIFullTrack30_L1Centrality3050_v1, process.HLT_HIFullTrack30_L1Centrality50100_v1, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/afs/cern.ch/work/g/ginnocen/public/SamplesForHFHLTStudies/ExampleFiles/ExampleFileDFlatPt/step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_PU_100_1_VHc.root',
    ),
...
_customInfo['inputFile' ]=  ['file:/afs/cern.ch/work/g/ginnocen/public/SamplesForHFHLTStudies/ExampleFiles/ExampleFileDFlatPt/step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_PU_100_1_VHc.root']
