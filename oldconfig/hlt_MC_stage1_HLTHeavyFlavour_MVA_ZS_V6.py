# /users/ginnocen/HLTHeavyFlavour_MVA_ZS/V6 (CMSSW_7_5_3_patch1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/ginnocen/HLTHeavyFlavour_MVA_ZS/V6')
)
...
process.hltPreHIIterativeTrackingForCalo60Jets = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
