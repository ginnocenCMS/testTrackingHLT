# /users/ginnocen/GlobaTrackingPPmenuHFlowpu/V11 (CMSSW_7_4_15)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/ginnocen/GlobaTrackingPPmenuHFlowpu/V11')
)
...
process.hltHIFullTrackFilterForDmesonjets = cms.EDFilter( "HLTSingleVertexPixelTrackFilter",
    ...
    vertexCollection = cms.InputTag( "hltVerticesL3" ),
...
process.hltPreDmesonPPTrackingGlobalDpt10 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.HLTBtagCSVSequenceL3PFJet60Eta2p1 = cms.Sequence( process.hltVerticesL3 + process.hltFastPixelBLifetimeL3AssociatorPFJet60Eta2p1 + process.hltFastPixelBLifetimeL3TagInfosPFJet60Eta2p1 + process.hltL3SecondaryVertexTagInfosPFJet60Eta2p1 + process.hltL3CombinedSecondaryVertexBJetTagsPFJet60Eta2p1 )
process.HLTEndSequence = cms.Sequence( process.hltBoolEnd )
process.HLTBtagCSVSequenceL3PFJet80Eta2p1 = cms.Sequence( process.hltVerticesL3 + process.hltFastPixelBLifetimeL3AssociatorPFJet80Eta2p1 + process.hltFastPixelBLifetimeL3TagInfosPFJet80Eta2p1 + process.hltL3SecondaryVertexTagInfosPFJet80Eta2p1 + process.hltL3CombinedSecondaryVertexBJetTagsPFJet80Eta2p1 )
process.HLTDtagSequenceL3PFJet60Eta2p1 = cms.Sequence( process.hltVerticesL3 + process.hltHIFullTrackCandsForDmesonjets + process.hltHIFullTrackFilterForDmesonjets + process.HLTtktkVtxForDmesonjetsPFJet60 + process.HLTktkFilterForDmesonjetsPFJet60 )
process.HLTDtagSequenceL3PFJet80Eta2p1 = cms.Sequence( process.hltVerticesL3 + process.hltHIFullTrackCandsForDmesonjets + process.hltHIFullTrackFilterForDmesonjets + process.HLTtktkVtxForDmesonjetsPFJet80 + process.HLTktkFilterForDmesonjetsPFJet80 )
process.HLTBtagSSVSequenceL3PFJet60Eta2p1 = cms.Sequence( process.hltVerticesL3 + process.hltFastPixelBLifetimeL3AssociatorPFJet60Eta2p1 + process.hltFastPixelBLifetimeL3TagInfosPFJet60Eta2p1 + process.hltL3SecondaryVertexTagInfosPFJet60Eta2p1 + process.hltL3SimpleSecondaryVertexTagsPFJet60Eta2p1 )
process.HLTBtagSSVSequenceL3PFJet80Eta2p1 = cms.Sequence( process.hltVerticesL3 + process.hltFastPixelBLifetimeL3AssociatorPFJet80Eta2p1 + process.hltFastPixelBLifetimeL3TagInfosPFJet80Eta2p1 + process.hltL3SecondaryVertexTagInfosPFJet80Eta2p1 + process.hltL3SimpleSecondaryVertexTagsPFJet80Eta2p1 )
...
process.HLT_AK4PFBJetBCSV60_Eta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAK4PFBJetBCSV60Eta2p1 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet30Eta2p1 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets30Eta2p1 + process.hltSingleAK4PFJet60Eta2p1 + process.eta2PFJetsEta2p1ForPFJet60 + process.reduceJetMultEta2p1ForPFJet60 + process.jets4bTaggerPFJet60Eta2p1 + process.HLTBtagCSVSequenceL3PFJet60Eta2p1 + process.hltBLifetimeL3FilterCSVPFJet60Eta2p1 + process.HLTEndSequence )
process.HLT_AK4PFBJetBCSV80_Eta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAK4PFBJetBSSV80Eta2p1 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet50Eta2p1 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets50Eta2p1 + process.hltSingleAK4PFJet80Eta2p1 + process.eta2PFJetsEta2p1ForPFJet80 + process.reduceJetMultEta2p1ForPFJet80 + process.jets4bTaggerPFJet80Eta2p1 + process.HLTBtagCSVSequenceL3PFJet80Eta2p1 + process.hltBLifetimeL3FilterCSVPFJet80Eta2p1 + process.HLTEndSequence )
process.HLT_AK4PFDJet60_Eta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAK4PFDJet60Eta2p1 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet30Eta2p1 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets30Eta2p1 + process.hltSingleAK4PFJet60Eta2p1 + process.eta2PFJetsEta2p1ForPFJet60 + process.reduceJetMultEta2p1ForPFJet60 + process.jets4bTaggerPFJet60Eta2p1 + process.HLTDtagSequenceL3PFJet60Eta2p1 + process.HLTEndSequence )
process.HLT_AK4PFDJet80_Eta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAK4PFDJet80Eta2p1 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet50Eta2p1 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets50Eta2p1 + process.hltSingleAK4PFJet80Eta2p1 + process.eta2PFJetsEta2p1ForPFJet80 + process.reduceJetMultEta2p1ForPFJet80 + process.jets4bTaggerPFJet80Eta2p1 + process.HLTDtagSequenceL3PFJet80Eta2p1 + process.HLTEndSequence )
process.HLT_AK4PFBJetBSSV60_Eta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAK4PFBJetBSSV60Eta2p1 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet30Eta2p1 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets30Eta2p1 + process.hltSingleAK4PFJet60Eta2p1 + process.eta2PFJetsEta2p1ForPFJet60 + process.reduceJetMultEta2p1ForPFJet60 + process.jets4bTaggerPFJet60Eta2p1 + process.HLTBtagSSVSequenceL3PFJet60Eta2p1 + process.hltBLifetimeL3FilterSSVPFJet60Eta2p1 + process.HLTEndSequence )
process.HLT_AK4PFBJetBSSV80_Eta2p1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAK4PFBJetBSSV80Eta2p1 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet50Eta2p1 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets50Eta2p1 + process.hltSingleAK4PFJet80Eta2p1 + process.eta2PFJetsEta2p1ForPFJet80 + process.reduceJetMultEta2p1ForPFJet80 + process.jets4bTaggerPFJet80Eta2p1 + process.HLTBtagSSVSequenceL3PFJet80Eta2p1 + process.hltBLifetimeL3FilterSSVPFJet80Eta2p1 + process.HLTEndSequence )
process.HLT_DmesonPPTrackingGlobal_Dpt10_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreDmesonPPTrackingGlobalDpt10 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingSequence + process.HLTDoLocalStripSequence + process.HLTIterativeTrackingForPA + process.hltPAFullCands + process.hltHIFullTrackFilterForDmeson + process.HLTtktkVtxForDmesonDpt10 + process.HLTtktkFilterForDmesonDpt10 + process.HLTEndSequence )
process.HLT_DmesonPPTrackingGlobal_Dpt20_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreDmesonPPTrackingGlobalDpt20 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingSequence + process.HLTDoLocalStripSequence + process.HLTIterativeTrackingForPA + process.hltPAFullCands + process.hltHIFullTrackFilterForDmeson + process.HLTtktkVtxForDmesonDpt20 + process.HLTtktkFilterForDmesonDpt20 + process.HLTEndSequence )
process.HLT_DmesonPPTrackingGlobal_Dpt30_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreDmesonPPTrackingGlobalDpt30 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingSequence + process.HLTDoLocalStripSequence + process.HLTIterativeTrackingForPA + process.hltPAFullCands + process.hltHIFullTrackFilterForDmeson + process.HLTtktkVtxForDmesonDpt30 + process.HLTtktkFilterForDmesonDpt30 + process.HLTEndSequence )
process.HLT_DmesonPPTrackingGlobal_Dpt40_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreDmesonPPTrackingGlobalDpt40 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingSequence + process.HLTDoLocalStripSequence + process.HLTIterativeTrackingForPA + process.hltPAFullCands + process.hltHIFullTrackFilterForDmeson + process.HLTtktkVtxForDmesonDpt40 + process.HLTtktkFilterForDmesonDpt40 + process.HLTEndSequence )
process.HLT_DmesonPPTrackingGlobal_Dpt50_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreDmesonPPTrackingGlobalDpt50 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingSequence + process.HLTDoLocalStripSequence + process.HLTIterativeTrackingForPA + process.hltPAFullCands + process.hltHIFullTrackFilterForDmeson + process.HLTtktkVtxForDmesonDpt50 + process.HLTtktkFilterForDmesonDpt50 + process.HLTEndSequence )
process.HLT_DmesonPPTrackingGlobal_Dpt60_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreDmesonPPTrackingGlobalDpt60 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingSequence + process.HLTDoLocalStripSequence + process.HLTIterativeTrackingForPA + process.hltPAFullCands + process.hltHIFullTrackFilterForDmeson + process.HLTtktkVtxForDmesonDpt60 + process.HLTtktkFilterForDmesonDpt60 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_AK4PFBJetBCSV60_Eta2p1_v1, process.HLT_AK4PFBJetBCSV80_Eta2p1_v1, process.HLT_AK4PFDJet60_Eta2p1_v1, process.HLT_AK4PFDJet80_Eta2p1_v1, process.HLT_AK4PFBJetBSSV60_Eta2p1_v1, process.HLT_AK4PFBJetBSSV80_Eta2p1_v1, process.HLT_DmesonPPTrackingGlobal_Dpt10_v1, process.HLT_DmesonPPTrackingGlobal_Dpt20_v1, process.HLT_DmesonPPTrackingGlobal_Dpt30_v1, process.HLT_DmesonPPTrackingGlobal_Dpt40_v1, process.HLT_DmesonPPTrackingGlobal_Dpt50_v1, process.HLT_DmesonPPTrackingGlobal_Dpt60_v1, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/data/yjlee/hltTrackingStudy/sample/twang-Pythia_D0pt35p0_Pthat35_TuneZ2_5020GeV_cfi_py_step2_20151105/step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_100_1_CO2.root',
    ),
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = '75X_mcRun2_asymptotic_ppAt5TeV_v0')
...
process.l1GtTriggerMenuXml = cms.ESProducer("L1GtTriggerMenuXmlProducer",
  ...
  DefXmlFile = cms.string('L1Menu_Collisions2015_5TeV_pp_reference_L1T_Scales_20141121.xml'),
...
_customInfo['globalTag' ]= "75X_mcRun2_asymptotic_ppAt5TeV_v0"
_customInfo['inputFile' ]=  ['file:/data/yjlee/hltTrackingStudy/sample/twang-Pythia_D0pt35p0_Pthat35_TuneZ2_5020GeV_cfi_py_step2_20151105/step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_100_1_CO2.root']
