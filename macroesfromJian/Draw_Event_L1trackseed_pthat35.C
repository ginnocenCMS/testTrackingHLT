...
void Draw_Event_L1trackseed_pthat35()
{
	TH1::SetDefaultSumw2();
    gStyle->SetOptFit(0);
    gStyle->SetOptStat(0);
	...
	TFile * input = new TFile("./openHLT_HF_HLTHeavyFlavour_MVA_V13_Pyquen_D0tokaonpion_D0pt35p0_Pthat35_1016_MBseed_fix.root");
	...
	cfg_evtfraction_Dpt20_L1seed->SaveAs("plots/cfg_evtfraction_Dpt20_L1trackseed_AllMB_D0pt35p0_Pthat35.png");
	cfg_evtfraction_Dpt20_L1seed->SaveAs("plots/cfg_evtfraction_Dpt20_L1trackseed_AllMB_D0pt35p0_Pthat35.pdf");
	...
	gentree->Draw("HLT_DmesonTrackingGlobalPt8_Dpt30_v1>>eventfired_Dpt30_MBseed","pt>35.&&abs(pdg)==421&&abs(eta)<1.0&&HLT_DmesonTrackingGlobalPt8_Dpt30_v1","goff");
	...
	cfg_evtfraction_Dpt30_L1seed->SaveAs("plots/cfg_evtfraction_Dpt30_L1trackseed_AllMB_D0pt35p0_Pthat35.png");
	cfg_evtfraction_Dpt30_L1seed->SaveAs("plots/cfg_evtfraction_Dpt30_L1trackseed_AllMB_D0pt35p0_Pthat35.pdf");
	...
	gentree->Draw("HLT_DmesonTrackingGlobalPt8_Dpt40_v1>>eventfired_Dpt40_MBseed","pt>35.&&abs(pdg)==421&&abs(eta)<1.0&&HLT_DmesonTrackingGlobalPt8_Dpt40_v1","goff");
	...
	cfg_evtfraction_Dpt40_L1seed->SaveAs("plots/cfg_evtfraction_Dpt40_L1trackseed_AllMB_D0pt35p0_Pthat35.png");
	cfg_evtfraction_Dpt40_L1seed->SaveAs("plots/cfg_evtfraction_Dpt40_L1trackseed_AllMB_D0pt35p0_Pthat35.pdf");
	...
	gentree->Draw("HLT_DmesonTrackingGlobalPt8_Dpt60_v1>>eventfired_Dpt60_MBseed","pt>35.&&abs(pdg)==421&&abs(eta)<1.0&&HLT_DmesonTrackingGlobalPt8_Dpt60_v1","goff");
	gentree->Draw("HLT_DmesonTrackingGlobalPt8_Dpt60_v1>>eventfired_Dpt60_L1Track8seed","pt>35.&&abs(pdg)==421&&abs(eta)<1.0&&HLT_DmesonTrackingGlobalPt8_Dpt60_v1&&L1_SingleS1Jet8_BptxAND&&(L1_SingleTrack8_Centrality0_10||L1_SingleTrack8_Centrality10_30||L1_SingleTrack8_Centrality30_50||L1_SingleTrack8_Centrality50_100)","goff");
	gentree->Draw("HLT_DmesonTrackingGlobalPt8_Dpt60_v1>>eventfired_Dpt60_L1Track12seed","pt>35.&&abs(pdg)==421&&abs(eta)<1.0&&HLT_DmesonTrackingGlobalPt8_Dpt60_v1&&L1_SingleS1Jet16_BptxAND&&(L1_SingleTrack12_Centrality0_10||L1_SingleTrack12_Centrality10_30||L1_SingleTrack12_Centrality30_50||L1_SingleTrack12_Centrality50_100)","goff");
	...
	cfg_evtfraction_Dpt60_L1seed->SaveAs("plots/cfg_evtfraction_Dpt60_L1trackseed_AllMB_D0pt35p0_Pthat35.png");
	cfg_evtfraction_Dpt60_L1seed->SaveAs("plots/cfg_evtfraction_Dpt60_L1trackseed_AllMB_D0pt35p0_Pthat35.pdf");
}
