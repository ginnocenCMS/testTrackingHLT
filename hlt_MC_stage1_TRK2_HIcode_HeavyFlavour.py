# /users/ginnocen/HLTHeavyFlavourTracking/V23 (CMSSW_7_4_6_patch3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/ginnocen/HLTHeavyFlavourTracking/V23')
)
...
process.eta2CaloJetsForjets = cms.EDFilter( "CaloJetSelector",
    filter = cms.bool( False ),
    src = cms.InputTag( "hltPuAK4CaloJetsCorrectedIDPassed" ),
    cut = cms.string( "abs(eta)<2.3" )
)
process.reduceJetMultForjets = cms.EDFilter( "LargestEtCaloJetSelector",
    maxNumber = cms.uint32( 3 ),
    filter = cms.bool( False ),
    src = cms.InputTag( "eta2CaloJetsForjets" )
)
process.jets4bTaggerForjets = cms.EDFilter( "EtMinCaloJetSelector",
    filter = cms.bool( False ),
    src = cms.InputTag( "reduceJetMultForjets" ),
...
process.hltHIPixel3PrimTracksForjets = cms.EDProducer( "PixelTrackProducer",
    ...
    RegionFactoryPSet = cms.PSet( 
      ...
      RegionPSet = cms.PSet( 
        ...
        input = cms.InputTag( "reduceJetMultForjets" ),
...
process.hltFastPixelBLifetimeL3Associator = cms.EDProducer( "JetTracksAssociatorAtVertex",
    jets = cms.InputTag( "jets4bTaggerForjets" ),
...
process.HLTDisplacedtktkFilterDmesonjets = cms.EDFilter( "HLTDisplacedtktkFilter",
    ...
    MinVtxProbability = cms.double( 0.000 ),
    MaxLxySignificance = cms.double( -1.0 ),
    DisplacedVertexTag = cms.InputTag( "HLTDisplacedtktkVtxProducerForDmesonjets" ),
    FastAccept = cms.bool( True ),
    MinCosinePointingAngle = cms.double( -2.0 ),
    MaxNormalisedChi2 = cms.double( 999999.0 ),
    MinLxySignificance = cms.double( 0.0 ),
...
process.HLTBtagCSVSequenceL3Forbjets = cms.Sequence( process.hltVerticesL3 + process.hltFastPixelBLifetimeL3Associator + process.hltFastPixelBLifetimeL3TagInfos + process.hltL3SecondaryVertexTagInfos + process.hltL3CombinedSecondaryVertexBJetTags )
...
process.HLT_PuAK4CaloJet80_v1_Forbjets = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleJet16BptxAND + process.hltPrePuAK4CaloJet80 + process.HLTPuAK4CaloJetsSequence + process.hltSinglePuAK4CaloJet80 + process.eta2CaloJetsForjets + process.reduceJetMultForjets + process.jets4bTaggerForjets + process.HLTDoHILocalPixelSequence + process.HLTHIRecopixelvetexingSequence + process.HLTDoHILocalStripSequence + process.HLTHIIterativeTrackingIteration0Forjets + process.HLTHIIterativeTrackingIteration1Forjets + process.hltHIIter1MergedForjets + process.HLTHIIterativeTrackingIteration2Forjets + process.hltHIIter2MergedForjets + process.HLTHIIterativeTrackingIteration3Forjets + process.hltHIIter3MergedForjets + process.HLTBtagCSVSequenceL3Forbjets + process.hltBLifetimeL3FilterCSV + process.HLTEndSequence )
process.HLT_PuAK4CaloJet80_v1_ForDmesonjets = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleJet16BptxAND + process.hltPrePuAK4CaloJet80 + process.HLTPuAK4CaloJetsSequence + process.hltSinglePuAK4CaloJet80 + process.eta2CaloJetsForjets + process.reduceJetMultForjets + process.jets4bTaggerForjets + process.HLTDoHILocalPixelSequence + process.HLTHIRecopixelvetexingSequence + process.HLTDoHILocalStripSequence + process.HLTHIIterativeTrackingIteration0Forjets + process.HLTHIIterativeTrackingIteration1Forjets + process.hltHIIter1MergedForjets + process.HLTHIIterativeTrackingIteration2Forjets + process.hltHIIter2MergedForjets + process.HLTHIIterativeTrackingIteration3Forjets + process.hltHIIter3MergedForjets + process.hltHIFullTrackCandsForDmesonjets + process.hltHIFullTrackFilterForDmesonjets + process.HLTDisplacedtktkVtxProducerForDmesonjets+ process.HLTDisplacedtktkFilterDmesonjets+process.HLTEndSequence )
process.HLT_HIFullTrack12_v1 = cms.Path( process.HLTBeginSequenceBPTX + process.hltL1sMinBias + process.hltPreDmesonFullTracking + process.HLTDoHILocalPixelSequence + process.HLTHIRecopixelvetexingSequence + process.HLTDoHILocalStripSequence + process.HLTHIIterativeTrackingIteration0ForGlobalPt8 + process.HLTHIIterativeTrackingIteration1ForGlobalPt8 + process.hltHIIter1MergedForGlobalPt8 + process.HLTHIIterativeTrackingIteration2ForGlobalPt8 + process.hltHIIter2MergedForGlobalPt8 + process.hltHIFullTrackCandsForDmeson + process.hltHIFullTrackFilter12 + process.HLTEndSequence )
process.HLT_DmesonFullTracking = cms.Path( process.HLTBeginSequenceBPTX + process.hltL1sMinBias + process.hltPreDmesonFullTracking + process.HLTDoHILocalPixelSequence + process.HLTHIRecopixelvetexingSequence + process.HLTDoHILocalStripSequence + process.HLTHIIterativeTrackingIteration0ForGlobalPt8 + process.HLTHIIterativeTrackingIteration1ForGlobalPt8 + process.hltHIIter1MergedForGlobalPt8 + process.HLTHIIterativeTrackingIteration2ForGlobalPt8 + process.hltHIIter2MergedForGlobalPt8 + process.hltHIFullTrackCandsForDmeson + process.hltHIFullTrackFilterForDmeson + process.HLTDisplacedtktkVtxProducerForDmeson+ process.HLTDisplacedtktkFilterDmeson+ process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_PuAK4CaloJet80_v1_Forbjets, process.HLT_PuAK4CaloJet80_v1_ForDmesonjets, process.HLT_HIFullTrack12_v1, process.HLT_DmesonFullTracking, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/afs/cern.ch/work/m/mnguyen/public/bJetTestFile/step2_DIGI_L1_DIGI2RAW_RAW2DIGI_L1Reco_PU_9_1_GT1.root',
    ),
...
_customInfo['inputFile' ]=  ['file:/afs/cern.ch/work/m/mnguyen/public/bJetTestFile/step2_DIGI_L1_DIGI2RAW_RAW2DIGI_L1Reco_PU_9_1_GT1.root']
